...
<body>
 <?PHP
    ...
    if ($_REQUEST['select2-9'] == 'A2-9'){
        ...
        redirect('part2-9.3.php');
    }elseif($_REQUEST['select2-9'] == 'C2-9'){
        redirect('part2-6.php');
...
<tr><td><center>
  He replies, "Sorry. I do not recognize you."
</center></td></tr>
...
<tr><td><center>
  ...
  <optgroup label="A">
  <option value="A2-9">Say "I need to know how to get out of here!"</option> 
  </optgroup>
  <optgroup label="B">
  <option value="B2-9">Say "Do you know who I am?"</option> 
  </optgroup>
  <optgroup label="C">
  <option value="C2-9">Say "Your mother!"</option> 
  </optgroup>
  <optgroup label="D">
