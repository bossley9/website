  ...
  return (
    <>
      <article class="what-is-a-feed">
        ...
        <p>
          A <dfn>feed</dfn>{" "}
          is a special website url you can use to get the latest updates for
          that website. With feeds you can get real-time updates for Youtube
          channels, Twitch streams, Acast podcasts, blog posts, and website
          articles from one place. All you need to do is <dfn>subscribe</dfn>
          {" "}
          to that feed with a <dfn>feed reader</dfn>.
        </p>
        <p>
          <em>Feeds give you control.</em>{" "}
          You won&#39;t see ads, miscellaneous spam, or content curated by some
          mysterious algorithm. You&#39;ll only see the content you signed up
          for. If you no longer want to get updates for a feed, you simply{" "}
        ...
        <p>
          To subscribe to a feed, you&#39;ll need a{" "}
          <dfn>feed reader</dfn>. A feed reader (aka &#34;aggregator&#34;,
          &#34;news reader&#34;, or &#34;RSS reader&#34;) keeps track of all
          your feed urls and organizes all your feed updates. Here are a few
          common feed readers:
        </p>
        <ul>
          <li>
