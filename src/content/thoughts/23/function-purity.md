...
![A merged Github PR that prevents dependent functions from being called in an inconsistent order.](https://sjc1.vultrobjects.com/sam-bossley-us-media/23-function-purity-fix-payment-methods.png)
...
![A merged Github PR that ensures that any time a user's ID changes, we refetch user data.](https://sjc1.vultrobjects.com/sam-bossley-us-media/23-function-purity-fix-substitutions.png)
